...
contract Student is Ownable {
    ...
    */
    function getSubjectsInWitchEnrolled()
        public
        view
    ...
    */
    function getEnrollementTokenId(address accountSCSubject)
        public
        view
        returns (uint256)
    {
    ...
    */
    function getUniversitiesWithDeposit()
        public
        view
        onlyOwner
        returns (address[] memory)
    ...
    * Las llamadas únicamente las puede realizar el propietario de esta cuenta de estudiante
    */
    function getDepositInUniversity(address scuniv)
        public
        view
        onlyOwner
        returns (uint256)
    ...
    */
    function recordEnrollInSubject(
        address accountSCUniversity,
